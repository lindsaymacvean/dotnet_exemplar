// This was a failed attempt to manipulate the swagger UI to make the api-key input field editable
// However having a js file injected into the swagger might be useful for the futuer so leavin it here.
