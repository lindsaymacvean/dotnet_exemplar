...
using dotnet_exemplar.Infrastructure.Data.Interceptors;
...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("dotnet_exemplarDb");
        Guard.Against.Null(connectionString, message: "Connection string 'dotnet_exemplarDb' not found.");
